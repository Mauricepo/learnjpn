...
export const useKanjiStore = create<kanjiStore>((set, get) => ({
  kanji: [
    { kanji: '私', hiragana: 'わたし', meaning: 'I (polite, general)' },
    { kanji: 'あなた', hiragana: 'あなた', meaning: "you (usually when one doesn't know the person)" },
    { kanji: 'さん', hiragana: 'さん', meaning: 'san (polite honorific)' },
    ...
    { kanji: '人', hiragana: 'じん', meaning: 'person from (nationality)' },
    { kanji: '日本語', hiragana: 'にほんご', meaning: 'Japanese language' },
    { kanji: '勉強', hiragana: 'べんきょう', meaning: 'study' },
    { kanji: '本', hiragana: 'ほん', meaning: 'book' },
    { kanji: 'これ', hiragana: 'これ', meaning: 'this' },
    { kanji: '何', hiragana: 'なに', meaning: 'what' },
    { kanji: 'それ', hiragana: 'それ', meaning: 'that' },
    { kanji: 'あれ', hiragana: 'あれ', meaning: 'that over there' },
    ...
    { kanji: 'この', hiragana: 'この', meaning: 'this one' },
    { kanji: 'その', hiragana: 'その', meaning: 'that one' },
    ...
    { kanji: 'ここ', hiragana: 'ここ', meaning: 'here' },
    { kanji: 'そこ', hiragana: 'そこ', meaning: 'there' },
    { kanji: 'あそこ', hiragana: 'あそこ', meaning: 'over there' },
    { kanji: 'どこ', hiragana: 'どこ', meaning: 'where' },
